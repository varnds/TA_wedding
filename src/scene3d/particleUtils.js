...
/** Match SpringFlowers scatter for pollen pockets. */
export function springFlowerSites(count = 48) {
  return Array.from({ length: count }, (_, i) => {
    const x = (seededRng(i) - 0.5) * 48;
    const z = -5 + seededRng(i + 50) * 18;
    return { x, y: terrainHeight(x, z) + 0.4, z };
  });
}
